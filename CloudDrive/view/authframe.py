...
class AuthFrame():
    ...
    def build_login(self):
        ...
        self.auth_username.insert(0, "mayuresh22")
        ...
        self.auth_password.insert(0, "Mayuresh@1000")
        ...
        self.login_btn = ctk.CTkButton(self.frame,
            ...
            hover_color="#1B387C",
            font=(os.getenv("DEFAULT_FONT"), int(os.getenv("HEADING_FONT6_SIZE"))),
            command=lambda: threading.Thread(target=AuthLogic.auth_user_login, args=(self.parent, self.frame), kwargs={"username" = , "password" = self.auth_password.get(), "errorlabel" = self.error_msg}).start()
        )
